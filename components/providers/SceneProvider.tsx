'use client'
// components/providers/SceneProvider.tsx
...
export function SceneProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <SceneContext.Provider value={{
      currentScene, prevScene, isTransitioning,
      navigateTo, goBack, setIsTransitioning,
      showAbout, setShowAbout,
      activeProject, activeTech, activeDomain,
      showTechPanel, cardPos,
      setActiveProject, setActiveTech, setActiveDomain,
      setShowTechPanel, setCardPos,
    }}>
      {children}
